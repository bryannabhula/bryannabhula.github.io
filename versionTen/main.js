...
var customdraw = new Button("Custom Draw", 20, 280, 130, 40, colArray[0][2], colArray[0][0], colArray[0][2], colArray[0][1], canvas);
var rotation = new Button("Rotation", 20, 370, 130, 40, colArray[0][2], colArray[0][0], colArray[0][2], colArray[0][1], canvas);
objectSet.push(rectangle, ellipse, circle, line, customdraw, square, rotation);

//width button for the size of brush
var smallwidth = new CustomWidth("S", 20, 325, 30, 30, 5, colArray[0][2], colArray[0][0], colArray[0][2], colArray[0][1], canvas);
var mediumwidth = new CustomWidth("M", 70, 325, 30, 30, 10, colArray[0][2], colArray[0][0], colArray[0][2], colArray[0][1], canvas);
var largewidth = new CustomWidth("L", 120, 325, 30, 30, 15, colArray[0][2], colArray[0][0], colArray[0][2], colArray[0][1], canvas);
