class control_draw{
    ...
    draw(){
        if(Button.selectedShape == "Rectangle" || Button.selectedShape == "Ellipse" || Button.selectedShape == "Circle" || Button.selectedShape == "Line" || Button.selectedShape == "Square" || Button.selectedShape == "Rotation"){
