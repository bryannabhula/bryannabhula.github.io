...
var rectangle = new Button("Rectangle", 20, 30, 130, 50, colArray[0][2], colArray[0][0], colArray[0][2], colArray[0][1], canvas);
var ellipse = new Button("Ellipse", 20, 100, 130, 50, colArray[0][2], colArray[0][0], colArray[0][2], colArray[0][1], canvas);
var circle = new Button("Circle", 20, 170, 130, 50, colArray[0][2], colArray[0][0], colArray[0][2], colArray[0][1], canvas);
var line = new Button("Line", 20, 240, 130, 50, colArray[0][2], colArray[0][0], colArray[0][2], colArray[0][1], canvas);
var customdraw = new Button("Custom Draw", 20, 310, 130, 50, colArray[0][2], colArray[0][0], colArray[0][2], colArray[0][1], canvas);
objectSet.push(rectangle, ellipse, circle, line, customdraw);

//width button for the size of brush
var smallwidth = new CustomWidth("S", 20, 380, 30, 30, 5, colArray[0][2], colArray[0][0], colArray[0][2], colArray[0][1], canvas);
var mediumwidth = new CustomWidth("M", 70, 380, 30, 30, 10, colArray[0][2], colArray[0][0], colArray[0][2], colArray[0][1], canvas);
var largewidth = new CustomWidth("L", 120, 380, 30, 30, 15, colArray[0][2], colArray[0][0], colArray[0][2], colArray[0][1], canvas);
