        ...
        mUp(e){
            ...
            if(this.mouseDown == true && this.rectBound == true){
                ...
                if (Button.selectedShape == "Rectangle"){
                    var temp = new Rectangle(this.xMouseStart, this.yMouseStart, this.dx, this.dy, colArray[2][6]);
                    this.objectSet.push(temp);
                }
                else if(Button.selectedShape == "Ellipse"){
                    var temp1 = new Ellipse(this.xMouseStart, this.yMouseStart, this.xMouse, this.yMouse, colArray[2][6]);
