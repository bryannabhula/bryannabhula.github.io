...
class Swatch{
    ...
    mMove(e){
        ...
        if(this.insideShape == true){
            this.stroke = "rgb(230,230,230)"; //declare what the colour would be when the mouse is inside of the button boundary (hover colour)
        }
        
        else{
            this.stroke = "rgb(250,250,250)"; //declare what the colour would be when the mouse is not inside (original colour)
        }
    ...
    draw(){
        ...
        ctx.lineWidth =10; // line width of the button
        ctx.fill();
        ctx.stroke();
    }
